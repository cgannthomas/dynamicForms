...
<div class="d-flex justify-content-end flex-shrink-0">
	...
	<a href="javascript:void(0);" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm  delete-form js-delete-btn" data-url="{{ route('admin.forms.destroy', $id) }}" title="Delete">
