...
@section('breadcrumbs')
	...
	@php
        ...
        $breadcrumbs = [
            ...
            ['title' => 'Add New Form', 'route' => null, 'status' => 'active']
            ];
    @endphp
...
@section('content')
    ...
    <!--begin::Content-->
		<div id="kt_account_profile_details" class="collapse show">
			<!--begin::Form-->
			<form id="create-dynamic-form" class="form" data-url="{{ route('admin.forms.store') }}" method="post">
				<br/> @csrf
					<!--begin::Input group-->
					<div class="row mb-6">
						<!--begin::Label-->
						...
						<div class="col-lg-8 fv-row">
							<input type="text" name="form_name" class="form-control form-control-lg form-control-solid" placeholder="Form Title name" />
						</div>
						<!--end::Col-->
					</div>
					<!--end::Input group-->
					...
					<div class="row mb-6">
						...
						<div class="col-lg-8 d-flex align-items-center">
                            <div class="form-check form-check-solid  fv-row">
                                <input class=" w-45px h-30px" type="radio" name="is_active" id="form-active" value="1">
                                <label class="form-check-label" for="form-active">Active</label>
                            </div>
                            <div class="form-check form-check-solid form-switch fv-row">
                                <input class=" w-45px h-30px" type="radio" name="is_active" id="form-inactive" value="0" checked="checked">
                    ...
                    <div class="table-responsive" id="append-formfields">
                        <!--begin::Table-->
                        <table class="table table-flush align-middle table-row-bordered table-row-solid gy-4 gs-9 dynamic_form_class" id="dynamic-form">
							<!--begin::Table head-->
                    ...
                    <!--begin::Actions-->
                    <div class="btn-div card-footer d-flex justify-content-center py-6 px-9">
                        <button type="reset" class="btn btn-light btn-active-light-primary me-2" id="reset-form">Discard</button>
                        <button type="Submit" class="btn btn-primary" id="dynamic-form-submit">Create Form</button>
                    </div>
                    <!--end::Actions-->
			</form>
			<!--end::Form-->
        ...
        @push('js')	
            <script src="{{ asset('admin-panel/assets/js/form/create_form.js') }}"></script>
        @endpush
@endsection